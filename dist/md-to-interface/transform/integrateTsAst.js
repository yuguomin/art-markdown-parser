...
exports.collateEnumAst = (enumName, enumBody) => {
    const singleEnumAst = objDeepCopy_1.objDeepCopy(enumTsAstTpl_1.enumAst);
...
exports.collateInterfaceAst = (interfaceName, interfaceBody, interfaceAst, finalName) => {
    const singleInterfaceAst = objDeepCopy_1.objDeepCopy(interfaceAst || interfaceTsAstTpl_1.exportInterfaceAst);
