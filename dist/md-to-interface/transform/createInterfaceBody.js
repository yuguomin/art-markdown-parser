...
exports.createInterfaceBody = (explainTable, currentParent) => {
    ...
    explainTable.cells.forEach(value => {
        const bodyTemplate = objDeepCopy_1.objDeepCopy(interfaceTsAstTpl_1.exportInterfaceAst.declaration.body.body[0]);
        ...
        if (value[parentsIndex] === currentParent && ([MarkDown_1.ParamType.array, MarkDown_1.ParamType.object].includes(typeValue) || isObjectArr)) {
            ...
            ;
            let childrenName = nameSpaceControl_1.checkRepeatName(value[renameIndex]) || nameSpaceControl_1.checkRepeatName(formatName);
